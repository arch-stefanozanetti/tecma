...
**Obiettivo strategico**: tutta l’app (FE, BE, integrazioni, E2E) testata al 100%, così che aggiungendo una feature non si rompa nulla. Vedi **[Piano 100% – tutta l’app](PLAN_100_PERCENT_FULL_APP.md)** per roadmap e deliverable.
...
| **FE** (tutto il src in report) | **69.84%** | 70.58% | 40.26% | **69.84%** | Include: **tutto** `src/**`; obiettivo 90%→100% (vedi PLAN_100_PERCENT_FULL_APP.md) |
