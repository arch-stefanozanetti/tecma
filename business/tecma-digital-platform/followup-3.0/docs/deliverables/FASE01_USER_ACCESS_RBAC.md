...
| 2026-03-20 | Audit **CRUD workspace** (`workspace.created` / `workspace.updated` con before/after nome+owner / `workspace.deleted`); OpenAPI: note audit + `owner_user_id` su POST/PATCH workspace, risposte 401/403/500. |
