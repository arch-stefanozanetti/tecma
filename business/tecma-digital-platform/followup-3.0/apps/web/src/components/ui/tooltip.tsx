      ...
      {open && (
        ...
        >
          <div className="flex items-center gap-2">
            {showIcon && <span className="size-2 shrink-0 rounded-full bg-primary-foreground/80" />}
          ...
          {secondLine != null && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] leading-tight opacity-90">{secondLine}</span>
            </div>
          )}
          {/* Arrow */}
          <div
            className={cn(
              ...
              side === 'top' && 'left-1/2 top-full -translate-x-1/2 border-t-foreground',
              side === 'bottom' && 'bottom-full left-1/2 -translate-x-1/2 border-b-foreground',
              side === 'left' && 'left-full top-1/2 -translate-y-1/2 border-l-foreground',
              side === 'right' && 'right-full top-1/2 -translate-y-1/2 border-r-foreground',
            )}
          />
        </div>
      )}
