...
const Checkbox = React.forwardRef<HTMLButtonElement, CheckboxProps>(
  (
    ...
    const boxClasses = cn(
      ...
      sizeClass,
      isDisabled && 'border-muted bg-muted cursor-not-allowed opacity-100',
...
export interface CheckboxWithLabelProps extends Omit<CheckboxProps, 'aria-label'> {
  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          <span className="font-body text-sm font-normal leading-5 text-foreground">{label}</span>
          {showOptional && (
