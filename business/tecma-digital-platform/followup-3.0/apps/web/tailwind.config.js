...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'auth-page':
          'radial-gradient(circle at top left, hsl(230 100% 94% / 1) 0%, var(--app-bg) 45%, hsl(15 80% 97% / 1) 100%)',
        'auth-sidebar':
          'linear-gradient(to bottom, hsl(230 50% 94%), hsl(238 100% 99%), hsl(15 80% 97%))',
