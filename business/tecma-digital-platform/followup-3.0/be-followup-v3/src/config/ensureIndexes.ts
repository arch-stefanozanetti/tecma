...
const CORE_INDEXES: IndexDefinition[] = [
  ...
  {
    collection: "tz_metrics_realtime",
    keys: { workspaceId: 1, projectId: 1, reportType: 1 },
    options: { unique: true },
  },
  { collection: "tz_metrics_realtime", keys: { workspaceId: 1, reportType: 1, updatedAt: -1 } },
  { collection: "tz_metrics_freshness", keys: { workspaceId: 1, projectId: 1 }, options: { unique: true } },
  { collection: "tz_metrics_freshness", keys: { workspaceId: 1, updatedAt: -1 } },
  { collection: "tz_report_snapshots", keys: { tokenHash: 1 }, options: { unique: true } },
  { collection: "tz_report_snapshots", keys: { expiresAt: 1 } },
  { collection: "tz_report_definitions", keys: { workspaceId: 1, updatedAt: -1 } },
  { collection: "tz_quotes", keys: { tokenHash: 1 }, options: { unique: true } },
  { collection: "tz_quotes", keys: { requestId: 1 } },
  ...
  { collection: "tz_workspace_entitlements", keys: { workspaceId: 1, feature: 1 }, options: { unique: true } },
  ...
  { collection: "tz_security_audit", keys: { at: -1 } },
  { collection: "tz_security_audit", keys: { workspaceId: 1, at: -1 } },
  { collection: "tz_security_audit", keys: { userId: 1, at: -1 } },
  { collection: "tz_account_lockout", keys: { lockedUntil: 1 } },
