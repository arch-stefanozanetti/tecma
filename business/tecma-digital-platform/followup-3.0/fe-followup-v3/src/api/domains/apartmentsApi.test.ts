...
describe("apartmentsApi", () => {
  ...
  it("requests/prices/inventory endpoints", () => {
    ...
    apartmentsApi.getApartmentPrices("a1");
    apartmentsApi.getApartmentInventory("a1");
    apartmentsApi.updateApartmentInventory("a1", { workspaceId: "ws1", inventoryStatus: "reserved" });
    apartmentsApi.upsertApartmentPriceCalendar("a1", { date: "2026-01-01", price: 1000, minStay: 2, availability: "available" });
    ...
    expect(mocks.getJson).toHaveBeenCalledWith("/apartments/a1/prices");
    expect(mocks.getJson).toHaveBeenCalledWith("/apartments/a1/inventory");
    expect(mocks.patchJson).toHaveBeenCalledWith("/apartments/a1/inventory", {
      workspaceId: "ws1",
      inventoryStatus: "reserved",
    });
    expect(mocks.putJson).toHaveBeenCalledWith("/apartments/a1/prices/calendar", {
      date: "2026-01-01",
      price: 1000,
      minStay: 2,
