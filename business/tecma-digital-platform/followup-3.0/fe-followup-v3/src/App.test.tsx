...
vi.mock("./api/followupApi", () => ({
  followupApi: {
    ...
    generateAiSuggestions: vi.fn().mockResolvedValue({ generatedAt: "", data: [], llmUsed: false }),
    executeAiSuggestion: vi.fn().mockResolvedValue({ ok: true, summary: "", toolCalls: [] }),
    decideAiSuggestion: vi.fn().mockResolvedValue(undefined),
