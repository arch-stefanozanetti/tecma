...
import { MermaidBlock } from "../executive/MermaidBlock";
import {
  COIMA_EXTRAS_TECMA,
  COIMA_GANTT_JOURNEY,
  COIMA_GANTT_ROADMAP,
  ...
  return (
    ...
    >
      ...
      <Tabs value={tab} onValueChange={setTab} className="w-full">
        ...
        <TabsContent value="visual" className="mt-4 grid gap-4 xl:grid-cols-3">
              ...
              <div className="h-[300px]">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart layout="vertical" data={barData} margin={{ left: 8, right: 16, top: 4, bottom: 4 }}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="si" stackId="a" fill={COL.si} name="Sì" />
                    <Bar dataKey="parziale" stackId="a" fill={COL.parziale} name="Parziale" />
                    <Bar dataKey="no" stackId="a" fill={COL.no} name="No" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </CardContent>
                  ...
                  <PieChart>
                    ...
                    <Tooltip
                      formatter={(value, name) => {
                        ...
                        const pct = totals.total ? ((n / totals.total) * 100).toFixed(1) : "0";
          ...
          <Card>
            ...
            <CardContent>
              <MermaidBlock chart={COIMA_GANTT_JOURNEY} zoomable />
            </CardContent>
          </Card>
          <Card className="xl:col-span-2">
            <CardHeader>
            ...
            <CardContent>
              <MermaidBlock chart={COIMA_GANTT_ROADMAP} zoomable />
            </CardContent>
          </Card>
        </TabsContent>
