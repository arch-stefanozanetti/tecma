...
const EnvSchema = z.object({
  ...
  /**
   * Opzionale: IP/CIDR (IPv4 o IPv6, separati da virgola) ammessi per POST /zeus/webhooks/sip/voice.
   * Vuoto = nessun filtro IP (resta il controllo secret/firma anti-replay).
   */
