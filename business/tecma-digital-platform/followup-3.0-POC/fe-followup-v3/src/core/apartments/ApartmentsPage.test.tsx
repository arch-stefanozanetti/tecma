...
const mocks = vi.hoisted(() => ({
  ...
  getRentOpenRequestBadgesMock: vi.fn(),
  getPriceAvailabilityMatrixMock: vi.fn(),
}));
...
vi.mock("../../api/followupApi", () => ({
  followupApi: {
    ...
    getRentOpenRequestBadges: mocks.getRentOpenRequestBadgesMock,
    getPriceAvailabilityMatrix: mocks.getPriceAvailabilityMatrixMock,
  },
}));
...
vi.mock("../../auth/projectScope", () => ({
  useWorkspace: () =>
    mockUseWorkspace({
      ...
      projects: [{ id: "proj-1", name: "Pilot rent", displayName: "Pilot rent" }],
    }),
}));
...
describe("ApartmentsPage", () => {
  beforeEach(() => {
    ...
    mocks.getRentOpenRequestBadgesMock.mockResolvedValue({ data: { badges: {} } });
    mocks.getPriceAvailabilityMatrixMock.mockResolvedValue({ units: [], dates: [], cells: {} });
  });
