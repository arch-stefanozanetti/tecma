...
const ReportsChartsSectionLazy = lazy(() =>
  import("./ReportsChartsSection").then((module) => ({ default: module.ReportsChartsSection }))
);
          ...
          {!loading && data.length > 0 && (
            <div className="border-b border-border bg-muted/10 p-4">
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                <Suspense
                  fallback={
                    <div className="rounded-lg border border-dashed border-border bg-card p-6 text-center text-sm text-muted-foreground lg:col-span-2">
                      Caricamento grafici…
                    </div>
                  }
                >
                  <ReportsChartsSectionLazy
                    ...
                    conversionsByProject={conversionsByProject}
                    avgTimesData={avgTimesData}
                  />
                </Suspense>
              </div>
            </div>
