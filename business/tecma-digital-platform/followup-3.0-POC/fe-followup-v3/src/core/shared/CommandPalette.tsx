...
const SECTION_COMMANDS: CommandSectionItem[] = [
  ...
  { kind: "section", id: "howItWorks", label: "Come funziona", hint: "Guida rapida ai flussi di prodotto" },
  ...
  { kind: "section", id: "reports", label: "Report", hint: "Andamento, funnel e viste aggregate" },
  { kind: "section", id: "rentRevenue", label: "Ricavi affitti", hint: "MRR stimato e trattative affitto chiuse" },
  { kind: "section", id: "priceAvailability", label: "Prezzi e disponibilità", hint: "Matrice prezzi" },
  { kind: "section", id: "projects", label: "Progetti", hint: "Configurazione progetti e dati collegati" },
  { kind: "section", id: "integrations", label: "Integrazioni", hint: "Connettori, regole, webhook e automazioni" },
  ...
  { kind: "section", id: "users", label: "Utenti", hint: "Utenti e visibilità (admin)" },
  { kind: "section", id: "emailFlows", label: "Email transazionali", hint: "Template mail di sistema (admin)" },
...
export const CommandPalette = ({
  ...
  const visibleSectionCommands = useMemo(() => {
    return SECTION_COMMANDS.filter((item) => {
      ...
      if (item.id === "rentRevenue" && projects.length > 0 && selectedProjectIds.length > 0) {
        if (!isPriceAvailabilityRelevant(projects, selectedProjectIds)) return false;
      }
