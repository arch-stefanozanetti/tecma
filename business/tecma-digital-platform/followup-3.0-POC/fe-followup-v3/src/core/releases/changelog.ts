...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: "0.16.1",
    date: "2026-04-22",
    title: "Cockpit: griglia Oggi (appuntamenti, da fare, trattative in evidenza)",
    releaseType: "patch",
    changes: [
      {
        type: "improvement",
        text: "Cockpit con tre colonne (appuntamenti oggi/domani, suggerimenti «Da fare», trattative urgenti per scadenza preventivo o stato fermo); deep link `openRequestId` e `openNewRequest` verso Trattative.",
      },
    ],
  },
  {
  ...
  },
  {
    version: "0.14.0",
    date: "2026-03-25",
    title: "Analisi marketing: funnel CRM per attribuzione + lead Webflow (platform API)",
    releaseType: "minor",
    changes: [
      {
        type: "feature",
        text: "Pagina Analisi marketing con funnel per canale UTM/click id, top appartamenti e stato connettori marketing (stub).",
      },
      {
        type: "feature",
