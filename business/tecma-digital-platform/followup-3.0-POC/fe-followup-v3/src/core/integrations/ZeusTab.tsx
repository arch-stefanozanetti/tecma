...
export function ZeusTab({ workspaceId, readOnly = false }: { workspaceId: string; readOnly?: boolean }) {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h2 className="text-lg font-semibold text-foreground">Agente ZEUS</h2>
        <p className="mt-1 text-sm text-muted-foreground">
          Configuralo qui, dentro <strong className="font-medium text-foreground">Integrazioni</strong>, come canale conversazionale del workspace.{" "}
