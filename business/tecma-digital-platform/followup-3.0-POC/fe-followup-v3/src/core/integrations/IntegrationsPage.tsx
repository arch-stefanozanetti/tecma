...
export const IntegrationsPage = ({ workspaceId, initialTab }: IntegrationsPageProps) => {
  ...
  const isZeusTab = activeTab === "zeus";
      ...
      <div className="px-5 pb-10 pt-8 lg:px-20">
        <div className="flex flex-wrap items-start gap-3">
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              {isZeusTab
                ? "Canali conversazionali, automazioni e connettori per estendere il CRM. ZEUS vive qui come configurazione operativa del workspace."
                : "Connettori, comunicazioni, automazioni, webhook e API per estendere il CRM."}
            </p>
            {isZeusTab && (
              <p className="mt-2 text-xs font-medium text-muted-foreground">
                Scheda attiva: <span className="text-foreground">ZEUS in Integrazioni</span>
              </p>
            )}
        ...
        >
          <TabsList className="w-full justify-start border-0 bg-transparent p-0" role="tablist">
            ...
            <TabsTrigger value="zeus" role="tab" aria-selected={activeTab === "zeus"} title="ZEUS in Integrazioni — telefono, WhatsApp, email">
              Agente ZEUS
            </TabsTrigger>
          </TabsList>
